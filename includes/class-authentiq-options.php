...
class Authentiq_Options
{
  ...
  protected function defaults() {
    return array(
      ...
      // Sign in form UI layout
      // 0: replace WP form, 1: add AQ as button, 2: add AQ as text link, 3: no AQ in UI
      'layout_signin_form' => 2,

      // When `layout_signin_form`=2, this allows admin to override display text
      'layout_signin_form_link_text' => esc_html__('...or use the Authentiq ID app', AUTHENTIQ_LANG),
      
      // Registration form UI layout
      // 0: replace WP form, 1: add AQ as button, 2: add AQ as text link, 3: no AQ in UI
      'layout_registration_form' => 2,

      // When `layout_registration_form`=2, this allows admin to override display text
      'layout_registration_form_link_text' => esc_html__('...or use the Authentiq ID app', AUTHENTIQ_LANG),

      // Authentiq button color scheme
      // 0: default, 1: purple, 2: orange, 3: grey, 4: white
